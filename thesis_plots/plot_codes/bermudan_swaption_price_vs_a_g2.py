...
lsm_result = []
for a in g2_as:
    GaussianModelInstance = GaussianModel(a=a, b=g2_b, sigma=g2_sigma, eta=g2_eta, rho=g2_rho,
                                          instant_forward_rates=instant_forward_rates)
...
plt.savefig(r'G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\bermudan_swaption_price_vs_a_g2.png',
          bbox_inches='tight')
