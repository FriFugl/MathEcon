...
plt.plot(maturities, market_spot_rates, label='Spot rate', color=colors['dark_petrol'], alpha=0.7)
plt.plot(maturities, market_forward_rates, label='Forward rate', color=colors['yellow'], alpha=0.7)
...
plt.savefig(r'G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\market_rate_data.png', bbox_inches='tight')
plt.show()