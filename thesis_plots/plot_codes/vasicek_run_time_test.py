...
def simul_run_time():
    ...
    for T in [5, 10, 15]:
        ...
        VasicekModelInstance = VasicekModel(
            a=vasicek_a, b=vasicek_b, sigma=vasicek_sigma
        )
...
backwards_pass_simulation_time_k = [
    np.float64(0.05319451093673706),
...
forward_pass_simulation_time_k = [
    np.float64(0.030107414722442626),
...
LSM_calibration_times_k = [
    np.float64(0.09484692811965942),
...
M1_calibration_times_k = [
    np.float64(0.13725085496902467),
...
M2_calibration_times_k = [
    np.float64(0.09228347539901734),
...
LSM_estimation_times_k = [
    np.float64(0.01570756673812866),
...
M1_estimation_times_k = [
    np.float64(0.015337183475494384),
...
M2_estimation_times_k = [
    np.float64(0.015375165939331055),
...
backwards_pass_simulation_time_N_calibration = [
    np.float64(0.028178791999816894),
...
forward_pass_simulation_time_N_calibration = [
    np.float64(0.031042537689208984),
...
M2_calibration_times_N_calibration = [
    np.float64(0.06613265037536621),
...
LSM_estimation_times_N_calibration = [
    np.float64(0.016073331832885743),
...
M1_estimation_times_N_calibration = [
    np.float64(0.015817384719848632),
...
M2_estimation_times_N_calibration = [
    np.float64(0.015831191539764405),
...
backwards_pass_simulation_time_N_estimation = [
    np.float64(0.11226835489273071),
...
forward_pass_simulation_time_N_estimation = [
    np.float64(0.06957784414291382),
...
M2_calibration_times_N_estimation = [
    np.float64(0.20917381048202516),
...
LSM_estimation_times_N_estimation = [
    np.float64(0.03353160619735718),
...
M1_estimation_times_N_estimation = [
    np.float64(0.04289272785186768),
...
M2_estimation_times_N_estimation = [
    np.float64(0.03437623023986816),
