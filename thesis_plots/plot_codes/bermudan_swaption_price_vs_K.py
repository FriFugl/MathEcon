...
for X in strikes:
    ...
    short_rates_calibration = VasicekModelInstance.simulate(r_0=vasicek_r_0, T=final_expiry, M=M, N=10000, method='exact')
    short_rates_estimation = VasicekModelInstance.simulate(r_0=vasicek_r_0, T=final_expiry, M=M, N=10000, method='exact')
...
# Display the plot
plt.tight_layout()
plt.savefig(r'G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\bermudan_swaption_price_vs_K.png',
         bbox_inches='tight')
plt.show()