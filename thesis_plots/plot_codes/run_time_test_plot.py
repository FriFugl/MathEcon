...
data = {
    'Category': ['LSM', 'LSM', 'M1', 'M1', 'M2'],
    'Subcategory': ['Vasicek', 'G2++'] * 2 + ['Vasicek'],
    'Backwards': [np.float64(0.09551172256469727), np.float64(0.18177083253860474), np.float64(0.13705304622650147), np.float64(0.19116333484649659), np.float64(0.09273351907730103)],
    'Forward': [np.float64(0.015597219467163087), np.float64(0.0160345721244812), np.float64(0.015344514846801757), np.float64(0.015752747058868408), np.float64(0.015352423191070557)],
    'IS': [np.float64(0.05323436737060547), np.float64(0.08099297523498535), np.float64(0.05323436737060547), np.float64(0.08099297523498535), np.float64(0.05323436737060547)],
    'OOS': [np.float64(0.03022165298461914), np.float64(0.04532495498657227), np.float64(0.03022165298461914), np.float64(0.04532495498657227), np.float64(0.03022165298461914)]
}
...
bar1 = ax.bar(x, df['IS'], label='Backward pass path simulation', color=colors['dark_grey'])
bar2 = ax.bar(x, df['OOS'], bottom=df['IS'], label='Forward pass path simulation', color=colors['medium_grey'])
bar3 = ax.bar(x, df['Backwards'], bottom=df['IS'] + df['OOS'], label='Backward pass', color=colors['light_grey'])
bar4 = ax.bar(x, df['Forward'], bottom=df['IS'] + df['OOS'] + df['Backwards'], label='Forward pass', color=colors['dark_red'])
...
plt.savefig(fr'G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\run_time_test.png',
          bbox_inches='tight')
plt.show()
