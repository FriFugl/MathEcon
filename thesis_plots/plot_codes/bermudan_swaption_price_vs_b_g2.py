...
g2_bs = [g2_b + (i / 10000) for i in offset]
for b in g2_bs:
    GaussianModelInstance = GaussianModel(
        a=g2_a,
        b=b,
...
plt.savefig(
    r"G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\bermudan_swaption_price_vs_b_g2.png",
    bbox_inches="tight",
)
