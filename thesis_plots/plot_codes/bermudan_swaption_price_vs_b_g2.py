...
for b in g2_bs:
    GaussianModelInstance = GaussianModel(a=g2_a, b=b, sigma=g2_sigma, eta=g2_eta, rho=g2_rho,
                                          instant_forward_rates=instant_forward_rates)
    ...
    short_rates_calibration, x_calibration, y_calibration, varphi_calibration = (GaussianModelInstance
                                                                                 .simulate(T=T,
                                                                                           M=M,
                                                                                           N=10000,
                                                                                           method='euler',
...
plt.savefig(r'G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\bermudan_swaption_price_vs_b_g2.png',
          bbox_inches='tight')
