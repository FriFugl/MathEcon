    ...
    for n in [100, 1000, 5000, 10000, 20000, 50000, 100000]:
        ...
        for i in range(100):
            (
                ...
                y_calibration,
                varphi_calibration,
            ) = GaussianModelInstance.simulate(T=T, M=M, N=10000, method="euler")
...
plt.tight_layout()
plt.savefig(
    r"G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\OOS_OOS_test_g2.png",
    bbox_inches="tight",
)
plt.show()
