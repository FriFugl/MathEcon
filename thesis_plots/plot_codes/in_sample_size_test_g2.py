    ...
    for n in [100, 1000, 5000, 10000, 20000, 50000, 100000]:
        ...
        for i in range(100):
            ...
            short_rates_estimation, x_estimation, y_estimation, varphi_estimation = (
                GaussianModelInstance.simulate(T=T, M=M, N=1000, method="euler")
            )
...
legend_elements = [
    Line2D(
        ...
        color="w",
        label="LSM",
        markerfacecolor=colors["dark_green"],
        markersize=8,
    ),
    Line2D(
        [0],
...
plt.tight_layout()
plt.savefig(
    r"G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\IS_IS_test_g2.png",
    bbox_inches="tight",
)
plt.show()
...
plt.tight_layout()
plt.savefig(
    r"G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\IS_OOS_test_g2.png",
    bbox_inches="tight",
)
plt.show()
