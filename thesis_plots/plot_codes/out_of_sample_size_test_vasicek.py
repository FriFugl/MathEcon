...
def simulate_data():
    ...
    for n in [100, 1000, 5000, 10000, 20000, 50000, 100000]:
        ...
        for i in range(100):
            short_rates_calibration = VasicekModelInstance.simulate(r_0=vasicek_r_0, T=T, M=M, N=10000, method='exact')
            short_rates_estimation = VasicekModelInstance.simulate(r_0=vasicek_r_0, T=T, M=M, N=n, method='exact')
...
plt.tight_layout()
plt.savefig(r'G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\OOS_OOS_test_vasicek.png',
          bbox_inches='tight')
plt.show()
