...
def simul_run_time():
    ...
    for T in [5, 10, 15]:
        ...
        exercise_dates = [
            i * (T / M) for i in range(1, M + 1) if i * (T / M) < T - alpha
        ]
        ...
        for i in range(100):
            ...
            (
                short_rates_calibration,
                x_calibration,
                y_calibration,
                varphi_calibration,
            ) = GaussianModelInstance.simulate(
                T=T, M=M, N=N_calibration, method="euler"
            )

            swap_rates_calibration, accrual_factors_calibration = (
                GaussianModelInstance.swap_rate(
            ...
            backwards_pass_simulation_times.append(
                time.time() - backwards_pass_simulation_start
            )
            ...
            short_rates_estimation, x_estimation, y_estimation, varphi_estimation = (
                GaussianModelInstance.simulate(T=T, M=M, N=N_estimation, method="euler")
            )

            swap_rates_estimation, accrual_factors_estimation = (
                GaussianModelInstance.swap_rate(
                    x_paths=x_estimation,
            ...
            forward_pass_simulation_times.append(
                time.time() - forward_pass_simulation_start
            )
        ...
        backwards_pass_simulation_time_T.append(
            np.mean(backwards_pass_simulation_times)
        )
        backwards_pass_simulation_time_T_sd.append(
            np.std(backwards_pass_simulation_times)
        )
    ...
    for k in [1, 2, 4, 12]:
        ...
        backwards_pass_simulation_time_k.append(
            np.mean(backwards_pass_simulation_times)
        )
        backwards_pass_simulation_time_k_sd.append(
            np.std(backwards_pass_simulation_times)
        )
    ...
    for N in [100, 1000, 10000, 100000]:
        ...
        for i in range(100):
            ...
            (
                ...
                y_calibration,
                varphi_calibration,
            ) = GaussianModelInstance.simulate(T=T, M=M, N=N, method="euler")
        ...
        backwards_pass_simulation_time_N_calibration.append(
            np.mean(backwards_pass_simulation_times)
        )
        backwards_pass_simulation_time_N_calibration_sd.append(
            np.std(backwards_pass_simulation_times)
        )

        forward_pass_simulation_time_N_calibration.append(
            np.mean(forward_pass_simulation_times)
        )
        forward_pass_simulation_time_N_calibration_sd.append(
            np.mean(forward_pass_simulation_times)
        )
    ...
    print(
        f"backwards_pass_simulation_time_N_calibration = {backwards_pass_simulation_time_N_calibration}"
    )
    print(
        f"forward_pass_simulation_time_N_calibration = {forward_pass_simulation_time_N_calibration}"
    )

    print(
        f"LSM_calibration_times_N_calibration = {LSM_calibration_times_N_calibration}"
    )
    ...
    for N in [100, 1000, 10000, 100000]:
        ...
        backwards_pass_simulation_time_N_estimation.append(
            np.mean(backwards_pass_simulation_times)
        )
        backwards_pass_simulation_time_N_estimation_sd.append(
            np.std(backwards_pass_simulation_times)
        )

        forward_pass_simulation_time_N_estimation.append(
            np.mean(forward_pass_simulation_times)
        )
        forward_pass_simulation_time_N_estimation_sd.append(
            np.mean(forward_pass_simulation_times)
        )
    ...
    print(
        f"backwards_pass_simulation_time_N_estimation = {backwards_pass_simulation_time_N_estimation}"
    )
    print(
        f"forward_pass_simulation_time_N_estimation = {forward_pass_simulation_time_N_estimation}"
    )
...
forward_pass_simulation_time_k = [
    np.float64(0.04557289123535156),
...
LSM_calibration_times_k = [
    np.float64(0.18488317251205444),
...
M1_calibration_times_k = [
    np.float64(0.19333568334579468),
...
LSM_estimation_times_k = [
    np.float64(0.01601651430130005),
...
M1_estimation_times_k = [
    np.float64(0.015863573551177977),
...
backwards_pass_simulation_time_N_calibration = [
    np.float64(0.09982162714004517),
...
forward_pass_simulation_time_N_calibration = [
    np.float64(0.09648611307144166),
...
LSM_calibration_times_N_calibration = [
    np.float64(0.12135479927062988),
...
M1_calibration_times_N_calibration = [
    np.float64(0.23178940296173095),
...
LSM_estimation_times_N_calibration = [
    np.float64(0.03875712633132935),
...
M1_estimation_times_N_calibration = [
    np.float64(0.03816066980361939),
...
backwards_pass_simulation_time_N_estimation = [
    np.float64(0.09148058176040649),
...
forward_pass_simulation_time_N_estimation = [
    np.float64(0.04576610088348389),
...
LSM_calibration_times_N_estimation = [
    np.float64(0.20926363945007323),
...
LSM_estimation_times_N_estimation = [
    np.float64(0.01618985891342163),
...
M1_estimation_times_N_estimation = [
    np.float64(0.015733680725097655),
...
plt.bar(
    ...
    edgecolor="white",
    width=barWidth,
    label="Simulation of In-sample paths",
)
plt.bar(
    r,
    forwards_pass_time,
    bottom=backwards_pass_time,
...
plt.savefig(
    rf"G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\g2_run_time_test.png",
    bbox_inches="tight",
)
plt.show()
