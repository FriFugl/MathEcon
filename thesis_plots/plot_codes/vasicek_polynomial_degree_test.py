...
plt.savefig(r'G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\polynomial_degree_test_mean_vasicek.png',
            bbox_inches='tight')
plt.show()
...
ax.spines['right'].set_visible(False)
ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.05), ncol=2, frameon=False)
plt.savefig(r'G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\polynomial_degree_test_sd_vasicek.png',
            bbox_inches='tight')
plt.show()
