...
for r_0 in r0_params:
    ...
    LSM_results.append(LSM_OOS)


fig, ax = plt.subplots(dpi=300, figsize=(8, 6))

plt.plot(offset, LSM_results, color=cfg.colors["dark_blue"], alpha=0.7)
...
plt.savefig(
    r"G:\Mit drev\Matematik-økonomi\Kandidat\Speciale\GitHub\MathEcon\thesis_plots\plots\bermudan_swaption_price_vs_r_0_vasicek.png",
    bbox_inches="tight",
)
