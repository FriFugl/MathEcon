...
from _vasicek_model import _simulate_vasicek_short_rate
...
exercise_dates = [i for i in range(T)]

short_rates = _simulate_vasicek_short_rate(r_0=r_0, a=a, b=b, sigma=sigma, T=T,M=M, method='exact', N=100)
